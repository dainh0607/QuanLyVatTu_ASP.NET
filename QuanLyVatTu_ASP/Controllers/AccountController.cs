...
namespace QuanLyVatTu_ASP.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(string hoTen, string email, string password, string confirmPassword)
        {
            ...
            // Tạo MaHienThi tự động - UPDATE: Để DB tự sinh (Computed Column)
            ...
            try
            {
                ...
                {
                    // MaHienThi = maHienThi, // Bỏ gán manual
                    HoTen = hoTen,
                    Email = email,
            ...
            catch (Exception ex)
            {
                ...
                else
                {
                    ...
                    ViewBag.RegisterError = "Lỗi đăng ký: " + ex.Message + " | " + innerMsg;
                }
        ...
        public async Task<IActionResult> GoogleCallback()
        {
            ...
            else
            {
                ...
                {
                    // MaHienThi = "KH" + DateTime.Now.ToString("yyyyMMddHHmmss") + new Random().Next(10, 99).ToString(), // Auto generated by DB
