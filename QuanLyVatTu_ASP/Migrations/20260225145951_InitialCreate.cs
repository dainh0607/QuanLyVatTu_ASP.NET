        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsVATInvoice = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    SoHoaDonVAT = table.Column<string>(type: "nvarchar(50)", nullable: true),
                    TenCongTy = table.Column<string>(type: "nvarchar(200)", nullable: true),
                    MaSoThue = table.Column<string>(type: "nvarchar(20)", nullable: true),
                    DiaChiDKKD = table.Column<string>(type: "nvarchar(500)", nullable: true),
                    EmailNhanHoaDon = table.Column<string>(type: "nvarchar(200)", nullable: true),
                    TenNguoiBan = table.Column<string>(type: "nvarchar(200)", nullable: true),
                    MaSoThueBan = table.Column<string>(type: "nvarchar(20)", nullable: true),
                    DiaChiNguoiBan = table.Column<string>(type: "nvarchar(500)", nullable: true),
                    ThueSuat = table.Column<decimal>(type: "decimal(5,2)", nullable: true, defaultValue: 10m),
                    GhiChuVAT = table.Column<string>(type: "nvarchar(500)", nullable: true)
                },
                constraints: table =>
                {
